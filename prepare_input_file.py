...
def main(): #main(opt):
	#my_path = 'D:/UFZ/CHEMBIOME/databases/final_dataset_extracted_biocyc/dataset_2_model'
	#input_file = my_path+'/For_MetaTrans_rxns_smiles.csv'
	#output_file = my_path + '/MetaTrans_prepared_rxns_smiles.csv'
	input_file = 'smile_biotransformation.csv' #opt.input_file
	output_file = 'bio_prediction.csv' #opt.output_file
	count_invalid = 0
	...
	for i in range(0,len(lines)-1):
		...
		if not check_smile(smiles):
			print(i, '==', mol_id, '\tinvalid SMILES:\t', smiles)
